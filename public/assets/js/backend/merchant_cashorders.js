define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'merchant_cashorders/index' + location.search,
                    add_url: 'merchant_cashorders/add',
                    edit_url: 'merchant_cashorders/edit',
                    del_url: 'merchant_cashorders/del',
                    multi_url: 'merchant_cashorders/multi',
                    import_url: 'merchant_cashorders/import',
                    table: 'merchant_cashorder',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'order_status', title: __('Order_status'), searchList: {"未确认":__('未确认'),"已入账":__('已入账'),"已发货":__('已发货'),"已退款":__('已退款')}, formatter: Table.api.formatter.normal,custom:{"未确认":'danger'},class: 'order-status'},
