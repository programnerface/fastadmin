define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'merchant_squareorders/index' + location.search,
                    add_url: 'merchant_squareorders/add',
                    edit_url: 'merchant_squareorders/edit',
                    del_url: 'merchant_squareorders/del',
                    multi_url: 'merchant_squareorders/multi',
                    import_url: 'merchant_squareorders/import',
                    table: 'merchant_squareorders',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'order_status', title: __('Order_status'), searchList: {"未确认":__('未确认'),"已入账":__('已入账'),"已发货":__('已发货'),"已退款":__('已退款')}, formatter: Table.api.formatter.status,custom:{"未确认":'danger'}},
