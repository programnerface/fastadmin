        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    add_url: 'venmo/add',
                    venderadd_url: 'venmo/venderadd',
                    venderedit_url: 'venmo/venderedit',
                    merchantadd_url: 'venmo/merchantadd',
                    merchantedit_url: 'venmo/merchantedit',
                    edit_url: 'venmo/edit',
                    del_url: 'venmo/del',
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'account', title: __('Venmo账号'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content},
...
//                                     return ''
//                                 }else{
                                value ='/sFGucSHOMQ.php/venmo/invoice.html?'
