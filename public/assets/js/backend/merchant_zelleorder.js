define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'merchant_zelleorder/index' + location.search,
                    add_url: 'merchant_zelleorder/add',
                    edit_url: 'merchant_zelleorder/edit',
                    del_url: 'merchant_zelleorder/del',
                    multi_url: 'merchant_zelleorder/multi',
                    import_url: 'merchant_zelleorder/import',
                    table: 'merchant_zelleorder',
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'merchant_name', title: __('Merchant_name'), operate: 'LIKE', table: table, class: 'autocontent', formatter: Table.api.formatter.content,escape: false},
                        {field: 'order_num', title: __('Order_num'), operate: 'LIKE'},
                        {field: 'order_date', title: __('Order_date'), operate:'RANGE', addclass:'datetimerange', autocomplete:false,formatter: Table.api.formatter.datetime,datetimeFormat:'YYYY-MM-DD'},
                        ...
                        {field: 'fees', title: __('Fees'), operate:'BETWEEN',class: 'merchant-fees',formatter: function (value, row, index) {
                        ...
                        {field: 'order_status', title: __('Order_status'), searchList: {"未确认":__('未确认'),"已入账":__('已入账')}, formatter: Table.api.formatter.normal,custom:{"未确认":'danger'},class: 'order-status'},
