        ...
        index: function () {
            ...
            Table.api.init({
                extend: {
                    ...
                    add_url: 'cash/add',
                    venderadd_url: 'cash/venderadd',
                    venderedit_url: 'cash/venderedit',
                    merchantadd_url: 'cash/merchantadd',
                    merchantedit_url: 'cash/merchantedit',
                    edit_url: 'cash/edit',
                    del_url: 'cash/del',
                ...
                columns: [
                    [
                        ...
                        {field: 'vendor_invoice', title: __('发票'), operate: 'LIKE', table: table,  class: 'autocontent', visible: name,formatter:function (value, row, index){
                                ...
                                value ='/sFGucSHOMQ.php/cash/invoice.html?'
                                value = Fast.api.escape(value);
                                return '<a href="' + value + 'order_num=' + row.order_num + '">' + '发票' + '</a>';
                            }},
