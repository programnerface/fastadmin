            ...
            formatter: {
                ...
                images: function (value, row, index) {
                    ...
                    $.each(arr, function (i, value) {
                        ...
                        html.push('<a href="javascript:"><img class="' + classname + '" data-tips-image src="' + url + '" /></a>');
                    });
                    return html.join(' ');
                },
                ...
                normal: function (value, row, index) {
                    ...
                    if (this.operate != false) {
                        ...
                        html = '<a href="javascript:;"  data-toggle="tooltip"  data-field="' + this.field + '" data-value="' + value + '">' + html + '</a>';
                    }
                    return html;
                },
