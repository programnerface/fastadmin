<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\website\phpstudy_pro\WWW\fastadmin.com\public/../application/admin\view\venmo\edit.html";i:1733480389;s:84:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\layout\default.html";i:1732090683;s:81:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\meta.html";i:1732090683;s:83:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\script.html";i:1732090683;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-country_id" data-rule="required" data-source="country/index" data-field="name"  data-primary-key="country_id" class="form-control selectpage" name="row[country_id]" type="text" value="223">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Zone_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-zone_id" data-rule="required" data-source="zone/index" data-field="name"  data-primary-key="zone_id" class="form-control selectpage" name="row[zone_id]" type="text" value="<?php echo htmlentities($row['zone_id'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
