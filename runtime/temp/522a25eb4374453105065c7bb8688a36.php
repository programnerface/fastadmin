<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:96:"D:\website\phpstudy_pro\WWW\fastadmin.com\public/../application/admin\view\withdraw_log\add.html";i:1733739799;s:84:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\layout\default.html";i:1732090683;s:81:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\meta.html";i:1732090683;s:83:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\script.html";i:1732090683;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-withdrawal_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[withdrawal_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    ...
    <div class="form-group" id="merchant_name">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-admin_id" class="form-control selectpage" data-source="auth/admin/index" data-primary-key="id" data-field="username" name="row[admin_id]" type="text">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Withdrawal_usamount'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-withdrawal_usamount" class="form-control" step="0.01" name="row[withdrawal_usamount]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Withdrawal_cnamount'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-withdrawal_cnamount" class="form-control" step="0.01" name="row[withdrawal_cnamount]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Withdrawal_way'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-withdrawal_way" class="form-control" name="row[withdrawal_way]" type="text">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-withdrawal_img" class="form-control" size="50" name="row[withdrawal_img]" type="text">
    ...
    <div class="form-group" id="withdrawal_status">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[withdrawal_status]-<?php echo $key; ?>"><input id="row[withdrawal_status]-<?php echo $key; ?>" name="row[withdrawal_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"已打款"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
