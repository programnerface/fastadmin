<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:89:"D:\website\phpstudy_pro\WWW\fastadmin.com\public/../application/admin\view\cash\edit.html";i:1733735070;s:84:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\layout\default.html";i:1732090683;s:81:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\meta.html";i:1732090683;s:83:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\script.html";i:1732090683;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group" id="order_date">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[order_date]" type="text" value="<?php echo $row['order_date']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Payer'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-payer" class="form-control" name="row[payer]" type="text" value="<?php echo htmlentities($row['payer'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-zone_id" data-rule="required" data-source="zone/index" data-primary-key="zone_id"  data-field="name" class="form-control selectpage" name="row[zone_id]" type="text" value="<?php echo htmlentities($row['zone_id'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-payment_address" class="form-control" name="row[payment_address]" type="text" value="<?php echo htmlentities($row['payment_address'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-confirm_code" class="form-control" name="row[confirm_code]" type="text" value="<?php echo htmlentities($row['confirm_code'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group" id="shipping_name">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('收货人'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-shipping_name" class="form-control" name="row[shipping_name]" type="text" value="<?php echo htmlentities($row['shipping_name'] ?? ''); ?>">
        </div>
    </div>
    ...
    <div class="form-group" id="amount">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-amount" class="form-control" step="0.01" name="row[amount]" type="number" value="<?php echo htmlentities($row['amount'] ?? ''); ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-payment_img" class="form-control" size="50" name="row[payment_img]" type="text" value="<?php echo htmlentities($row['payment_img'] ?? ''); ?>">
    ...
    <div class="form-group" id="vendor_invoice">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-vendor_invoice" class="form-control" name="row[vendor_invoice]" type="text" value="<?php echo htmlentities($row['vendor_invoice'] ?? ''); ?>">
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-order_check" class="form-control selectpicker" name="row[order_check]">
                <?php if(is_array($orderCheckList) || $orderCheckList instanceof \think\Collection || $orderCheckList instanceof \think\Paginator): if( count($orderCheckList)==0 ) : echo "" ;else: foreach($orderCheckList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['order_check'])?$row['order_check']:explode(',',$row['order_check']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
