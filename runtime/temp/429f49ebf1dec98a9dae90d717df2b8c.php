<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\website\phpstudy_pro\WWW\fastadmin.com\public/../application/admin\view\square\add.html";i:1733735978;s:84:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\layout\default.html";i:1732090683;s:81:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\meta.html";i:1732090683;s:83:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\script.html";i:1732090683;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group" id="fees">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-fees" class="form-control" step="0.01" name="row[fees]" type="number">
        </div>
    </div>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-order_check" class="form-control selectpicker" name="row[order_check]">
                <?php if(is_array($orderCheckList) || $orderCheckList instanceof \think\Collection || $orderCheckList instanceof \think\Paginator): if( count($orderCheckList)==0 ) : echo "" ;else: foreach($orderCheckList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"待审核"))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
