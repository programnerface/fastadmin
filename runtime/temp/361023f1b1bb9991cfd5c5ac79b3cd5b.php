<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:90:"D:\website\phpstudy_pro\WWW\fastadmin.com\public/../application/admin\view\refund\add.html";i:1733707219;s:84:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\layout\default.html";i:1732090683;s:81:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\meta.html";i:1732090683;s:83:"D:\website\phpstudy_pro\WWW\fastadmin.com\application\admin\view\common\script.html";i:1732090683;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8">
...
<script type="text/javascript">
    ...
    <div class="form-group" id="refund_date">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-refund_date" class="form-control datetimepicker" data-date-format="YYYY-MM-DD HH:mm:ss" data-use-current="true" name="row[refund_date]" type="text" value="<?php echo date('Y-m-d H:i:s'); ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Refund_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-refund_name" data-rule="required" class="form-control" name="row[refund_name]" type="text">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-refund_amount" data-rule="required" class="form-control" step="0.01" name="row[refund_amount]" type="number">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Refund_contact_info'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-refund_contact_info" data-rule="required" class="form-control" name="row[refund_contact_info]" type="text">
        </div>
    </div>
    <div class="form-group" id="refund_status">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[refund_status]-<?php echo $key; ?>"><input id="row[refund_status]-<?php echo $key; ?>" name="row[refund_status]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"处理中"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label> 
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-refund_img" class="form-control" size="50" name="row[refund_img]" type="text">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-refund_biz" class="form-control" name="row[refund_biz]" type="text">
        </div>
    </div>
