...
//        }
        ...
        try {
            ...
            //设置Token
            $admin->token = Random::uuid();
            Token::set($admin->token, $admin->id, $this->keeptime);
            ...
            $this->_logined = true;
            //注册成功的事件
            Hook::listen("user_register_successed", $this->_admin, $data);
...
//        Session::set("admin.safecode", $this->getEncryptSafecode($admin));
     ...
     * @return boolean
     */
    public function venderregister($username, $password, $email = '', $mobile = '', $extend = [])
    {
