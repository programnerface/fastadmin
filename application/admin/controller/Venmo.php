 ...
 * @icon fa fa-circle-o
 */
class Venmo extends Backend
{

    /**
     * Venmo模型对象
     * @var \app\admin\model\Venmo
     */
...
//    protected $dataLimit = 'personal';
    ...
    {
        parent::_initialize();
        $this->model = new \app\admin\model\Venmo;
...
//            exit();
    ...
    public function invoice($order_num)
    {
        ...
        if (empty($data['vendor_invoice'])) {
            $invoce = request()->domain()."/sFGucSHOMQ.php/venmo/invoice.html?order_num=".$data['order_num'];
